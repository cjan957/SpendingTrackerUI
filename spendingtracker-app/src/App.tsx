...
class App extends React.Component<{}, IState> {
        ...
        {authenticated ? (
          <div>
              ...
              <div className="row content">
                ...
                <div className="col-sm-9">
                  <div className="centered">
                    <SpendingContainer
                      tripTitleSelected={this.state.tripTitleSelected}
            ...
            <footer className="container-fluid">
              ...
              <iframe
                src="https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2Fspendingtrackerapp.azurewebsites.net%2F&layout=button&size=large&mobile_iframe=true&appId=134531130583735&width=73&height=28"
                width="73"
                height="28"
                scrolling="no"
                frameBorder="0"
  ...
  private getFaceRecognitionResult(image: string) {
    ...
    // const url =
    //   "https://southcentralus.api.cognitive.microsoft.com/customvision/v2.0/Prediction/c6e40392-8f97-4578-ac50-eb3e2801adf0/image?iterationId=334d2b75-4cba-4623-9a59-66f86fd5670a";
    // if (image === null) {
    //   return;
    // }
    ...
    //     "Prediction-Key": "8adeb8b26bc64305911c6178dffd6bc4",
    ...
    //       if (
    //         this.state.predictionResult.probability > 0.65 &&
    //         this.state.predictionResult.tagName === "Chanokpol"
    //       ) {
    //         this.setState({
    //           authenticated: true
    //         });
